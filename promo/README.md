...
- 0:25 드롭 B: **최신 실제 페이지**(홈 · 유승민 대표 · 이도경 이사 선임권)를 폰 안에서 스크롤·탭 → 폰이 내려가며 엔딩으로
- 0:35 엔딩: 빠진 것을, 더합니다. → 로고 → 상호·태그라인 → 연락처 → 고지 문구 → 불씨

표현 기준: 비용·보수·무료 관련 문구는 영상 어디에도 넣지 않음(선임권 페이지는 "손해사정사 선택, 고객님의 권리입니다."만 사용, 비용 문구가 있는 영역은 폰 화면에 비치지 않게 스크롤). 엔딩에 "보장 여부와 손해액은 보험계약 및 사고 내용에 따라 달라집니다." 고지.
